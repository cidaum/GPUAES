...
__device__ __constant__ uint InvSbox[256] = {
...
__device__ __constant__ uint logTable[256] = {
...
__device__ __constant__ uint iLogTable[256] = {
...
static const uint Rcon[] = { 0, 0x01000000, 0x02000000, 0x04000000, 0x08000000,
